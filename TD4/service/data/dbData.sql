...
INSERT INTO `annonce` (`id`, `titre`, `date`, `texte`, `prix`, `nom_annonceur`, `mail_annonceur`, `tel_annonceur`, `adr_annonceur`, `id_categorie`, `id_departement`) VALUES
(1,    'vente voiture', '2019-11-08 13:45:55', NULL,	6499.99,	'Dubois',	'Dubois@free.fr',	NULL,   NULL, 1, 3),
(2,	'PS5 + Jeu',   '2019-11-08 13:45:55',    'PS5 neuf et jeu du pack',    	1200,	NULL,	'Payet@free.fr',	0756323291,	NULL, 2, 1),
(3,	'Location local 56m2',  '2019-11-08 13:45:55',    'local pouvant servir de stockage ou de commerce bien situer en centre ville',    350,	'Bernard',	'Bernard@bouygtel.fr',	NULL, '2Tr boulvard Charlemagne 54000 Nancy', 3, 1);

INSERT INTO `categorie` (`id`, `nom`, `descr`) VALUES
(1, 'véhicule', NULL),
(2,	'Jeu Vidéo',    'Console et jeux vidéo matérialisé'),
(3,	'immobilié',    'location ou vente immobilière (préciser dans le titre)'),
(4, 'animaux', NULL);

INSERT INTO `photo` (`id`, `file`, `date`, `taille_octet`, `id_annonce`) VALUES
(1, 'images/ps5/ps5',   '2019-11-12 18:45:55', 3000000, 2),
(2, 'images/ps5/Horizon',    '2019-11-12 18:46:45', 2800000, 2);

INSERT INTO `departement` (`id`, `file`, `date`, `taille_octet`, `id_region`) VALUES
(1, 54, 'meurthe et moselle', 1),
(2, 88, 'vosges', 1),
(3, 93, 'seine-saint-denis', 2);
